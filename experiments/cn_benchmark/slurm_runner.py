"""
# scp is Copyright (C) 2008 James Bardin <j.bardin@gmail.com> 
"""
...
class SlurmRunner(NeptuneRunner):
    ...
    docker_container : str, optional
        ...
        Defaults to marcosfelt/summit:cn_benchmark
    neptune_project : str
    ...
    def run(self, **kwargs):
        ...
        # Make the .cn_benchmark folder on the remote server if it doesn't exist
        remote_path = f".cn_benchmark/{uuid_val}"
